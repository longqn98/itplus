...
<!-- conten -->
	<div class="content">
		...
		<div class="quanau">
				...
				<div class="in-line">
					<div class="para-an">
						<h3>MẪU ÁO SƠMI MỚI NHẤT</h3>
						<p>Hàng việt nam chất lượng cao</p>
					</div>
					<div class="lady-in">
						<div class="col-md-4 you-para">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/somi1.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p> Áo Sơ Mi Linen Sọc Xám ASM1276</p>
							<span>$250.000đ  | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ hàng </a></span>
						</div>
						<div class="col-md-4 you-para">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/somi2.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Áo Sơ Mi Ngắn Tay Sọc Xanh Đen </p>
							<span>$300.000đ  | <label class="cat-in"> </label> <a href="#">thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para para-grid">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/somi3.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Áo Sơ Mi Linen Sọc Xanh ASM1278</p>
							<span>$350.000đ  | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						
						<div class="col-md-4 you-para">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/somi4.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Áo Sơ Mi Linen Rêu ASM1268</p>
							<span>$779.00đ | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/somi5.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Áo Sơ Mi Trắng ASM1268</p>
							<span>$790.000đ  | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para para-grid">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/somi6.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Áo Sơ Mi Xanh ASM1268 </p>
							<span>$650.000  | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para para-grid">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/somi7.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Áo Sơ Mi SM1268 </p>
							<span>$579.000 | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para para-grid">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/somi8.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Áo Sơ Mi SM1268</p>
							<span>$850.000. | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para para-grid">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/somi9.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
