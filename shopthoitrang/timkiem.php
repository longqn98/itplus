...
<!-- conten -->
	<div class="content">
		...
		<div class="quanau">
				...
				<div class="in-line">
					<div class="para-an">
						<h3>CÁC MẪU BẠN ĐANG CẦN TÌM</h3>
						<p>Hàng việt nam chất lượng cao</p>
					</div>
					<div class="lady-in">
						<div class="col-md-4 you-para">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/kaki1.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p> Quần Short Kaki QS147</p>
							<span>$200.000đ  | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ hàng </a></span>
						</div>
						<div class="col-md-4 you-para">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/kaki2.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Quần Short Đen QS149</p>
							<span>$270.000đ  | <label class="cat-in"> </label> <a href="#">thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para para-grid">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/kaki3.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Quần Short Kaki QS148</p>
							<span>$500.000đ  | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						
						<div class="col-md-4 you-para">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/kaki4.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Quần Short Kaki QS152</p>
							<span>$279.00đ | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/kaki5.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Quần Short Kaki QS155</p>
							<span>$390.000đ  | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para para-grid">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/kaki6.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Quần Short Kaki QS100 </p>
							<span>$250.000  | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para para-grid">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/kaki7.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Quần Short Kaki QS152</p>
							<span>$179.000 | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para para-grid">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/kaki8.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Quần Short Kaki QS154</p>
							<span>$250.000. | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para para-grid">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/kaki9.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Quần Short Kaki QS158</p>
							<span>$379.000  | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						<div class="clearfix"> </div>
					</div>
				</div>
