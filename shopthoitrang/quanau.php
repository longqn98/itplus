...
<!-- conten -->
	<div class="content">
		...
		<div class="quanau">
				...
				<div class="in-line">
					<div class="para-an">
						<h3>MẪU QUẦN ÂU MỚI NHẤT</h3>
						<p>Hàng việt nam chất lượng cao</p>
					</div>
					<div class="lady-in">
						<div class="col-md-4 you-para">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/au11.jpg" alt=" " ></a>
							<div class="you-in">
						...
						<div class="col-md-4 you-para">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/au77.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
						...
						<div class="col-md-4 you-para para-grid">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/au33.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
						...
						<div class="col-md-4 you-para">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/au44.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Quần âu Aristino ATR01008</p>
							<span>$279.00đ | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/au55.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Quần âu nam Aristino ATR02208</p>
							<span>$390.000đ  | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para para-grid">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/au66.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Quần âu nam Aristino ATR02008 </p>
						...
						<div class="col-md-4 you-para para-grid">
							...
							<p>Quần âu nam Biluci AK532</p>
							<span>$179.000 | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para para-grid">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/au88.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>Quần âu nam Aristino ATR00208</p>
							<span>$250.000. | <label class="cat-in"> </label> <a href="#">Thêm vào giỏ </a></span>
						</div>
						<div class="col-md-4 you-para para-grid">
							<a href="chitiet.php"><img class="img-responsive pic-in" src="images/au99.jpg" alt=" " ></a>
							<div class="you-in">
								<span>15<label>%</label></span>
							<small>off</small>
							</div>
							<p>QUẦN ÂU NAM QAVB013TTT</p>
